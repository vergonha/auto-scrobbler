...
var require_auth = __commonJS({
  "backend/auth.js"(exports, module2) {
    ...
    var MobileAuth2 = class {
      ...
      getMobileSession() {
        const sig = md52([
          ...
          "password",
          this.password || process.env.PASSWD,
          "username",
...
// backend/scrobble.js
var scrobble_exports = {};
__export(scrobble_exports, {
  default: () => Scrobble
});
module.exports = __toCommonJS(scrobble_exports);
var md5 = require_md5();
...
var i = new Scrobble();
i.scrobble("harbor", "clairo", parseInt(Math.floor(Date.now() / 1e3))).then((sk) => console.log(sk));
